...
highest <- c("US", "Russia", "United Kingdom", "Italy", "Germany", "Netherlands", "France", "Spain", "India")
...
pg1 <- data %>%
  ...
  labs(x = "days after 100 cases", y = "total cases (limited to 2.000.000)", color = "")
...
```{r, fig.height=6.75, fig.width = 14}
...
```{r, , fig.height=11.25, fig.width = 14}
